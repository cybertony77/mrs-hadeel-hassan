...
export default function HomeworksVideos() {
  ...
  const deleteSessionMutation = useMutation({
    mutationFn: async (id) => {
      const response = await apiClient.delete(`/api/homeworks_videos?id=${id}`);
      return response.data;
    },
    onSuccess: () => {
  ...
  const openEditPage = (session) => {
    router.push(`/dashboard/manage_online_system/homeworks_videos/edit?id=${session._id}`);
  };
    ...
    <div className="page-wrapper" style={{ 
        ...
        <div className="filters-container" style={{
          ...
          <div className="filter-row" style={{
            ...
            <div className="filter-group" style={{ flex: 1, minWidth: 180 }}>
              ...
              <HomeworkVideoPaymentStateSelect
      ...
      <div className="add-video-btn-container" style={{ marginBottom: '24px', display: 'flex', justifyContent: 'flex-end' }}>
        <button
          ...
          onClick={() => router.push('/dashboard/manage_online_system/homeworks_videos/add')}
          style={{
            padding: '12px 24px',
