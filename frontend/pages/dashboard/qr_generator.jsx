        ...
        try {
          ...
          if (element.tagName.toLowerCase() === 'canvas') {
            ...
            if (container) {
              ...
              gradient.addColorStop(0, '#c49256');
              gradient.addColorStop(1, '#c49256');
    ...
    <div style={{ 
      ...
      <style jsx>{`
        ...
        .hidden-qr .qr-container {
          background: linear-gradient(150deg,rgba(247, 162, 77, 1) 0%, rgba(204, 204, 204, 1) 50%, rgba(217, 152, 82, 1) 100%);
          padding: 10px;
          border-radius: 20px;
          overflow: hidden;
          display: flex;
            ...
            <div className="qr-center-wrapper">
              <div className="qr-display">
                <div className="qr-container">
                  <QRCode
                    id="single-qr-svg"
                    value={`https://wa.me/201023345469/?id=${singleId}`}
                    size={qrSize}
                    ecLevel="H"
                    logoImage="/logo.png"
                    logoWidth={logoSize}
          ...
          <div className="hidden-qr">
            {qrIds.map((id) => (
              <div className="qr-container" key={id}>
                <QRCode
                  id={`hidden-qr-${id}`}
                  value={`https://wa.me/201023345469//?id=${id}`}
                  size={qrSize}
                  ecLevel="H"
                  logoImage="/logo.png"
                  logoWidth={logoSize}
